...
// import BrandLogo from "@/app/dashboard/_brand-logo"
// import Link from "next/link"

// function ResetPassword() {
//     return (
//         <main className="w-full min-h-screen max-w-md mx-auto p-6 flex flex-col justify-center">
